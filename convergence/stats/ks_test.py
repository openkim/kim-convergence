...
def check_population_cdf_args(population_cdf: str, population_args: tuple):
    ...
    if number_of_required_arguments != number_of_arguments:
        ...
        if number_of_arguments == 0:
            msg += 'no input argument is provided.'.format(number_of_arguments)
        elif number_of_arguments == 1:
            msg += '1 input argument is provided.'.format(number_of_arguments)
        else:
...
def ks_test(time_series_data: np.ndarray,
    ...
    args.append(population_loc)
    args.append(population_scale)
