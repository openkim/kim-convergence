...
class TestStatsModule(unittest.TestCase):
    ...
    def test_cross_covariance(self):
        ...
        ab = np.array([-4.783685406261340e-03, -1.138527201306546e-02,
                       ...
                       -5.585275066021979e-03, 9.824294199818826e-05,
                       1.343198013572316e-02, 1.093106704175784e-03,
                       3.212505155860149e-04, 4.031577169803108e-03],
                      dtype=np.float64)
    ...
    def test_cross_correlate(self):
        ...
        ab = np.array([0.042606000505134, -0.329786944440556,
                       ...
                       0.522912208147887, 0.164804634946593,
                       0.188353306047153, -0.088233151288948,
                       0.12911468123748, -0.179572682320018,
                       -0.042809526704892, -0.221866360790168,
                       -0.077043562380959, 0.045515405712984,
                       0.086871223237283], dtype=np.float64)
