...
class TestStatsBetaModule(unittest.TestCase):
    ...
    def test_beta(self):
        ...
        self.assertAlmostEqual(cr.beta(0.0342, 171),
                               24.070498359873497, places=10)

    def test_betacf(self):
        """Test betacf function."""
        self.assertAlmostEqual(cr.betacf(
    ...
    def test_betai(self):
        ...
        self.assertAlmostEqual(cr.betai(0.0342, 171, 1e-10),
    ...
    def test_betai_cdf(self):
        ...
        self.assertAlmostEqual(cr.betai_cdf(
