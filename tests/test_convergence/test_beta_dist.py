...
class TestBeta_DistModule(unittest.TestCase):
    ...
    def test_beta(self):
        """Test beta function."""
        self.assertEqual(cr.beta_dist.beta(1, 1), 1.0)

        # self.assertAlmostEqual(
        #     cr.beta_dist.beta(-100.3, 1.e-200), gamma(1.e-200), 3)

        self.assertAlmostEqual(cr.beta_dist.beta(0.0342, 171),
                               24.070498359873497, places=10)

    def test_betacf(self):
        """Test betacf function."""
        self.assertAlmostEqual(cr.beta_dist.betacf(
            0.1, 0.1, 0.1), 1.019300784881282, places=10)

    def test_betai(self):
        """Test betai function."""
        self.assertEqual(cr.beta_dist.betai(1, 1, 1), 1.0)

        self.assertAlmostEqual(cr.beta_dist.betai(0.0342, 171, 1e-10),
    ...
    def test_betai_cdf(self):
        ...
        self.assertAlmostEqual(cr.beta_dist.betai_cdf(
