...
class TestStatsSNormalDistModule(unittest.TestCase):
    ...
    def test_s_normal_inv_cdf(self):
        ...
        prob = np.array([0.5, 0.95, 0.995, 0.9995, 0.99995, 0.999995,
                         0.9999995, 0.99999995, 0.999999995, 0.9999999995],
                        dtype=np.float64)

        _ppf = np.array([0.000, 1.645, 2.576, 3.291, 3.891,
        ...
        prob = np.array([0.9, 0.99, 0.999, 0.9999, 0.99999, 0.999999,
                         0.9999999, 0.99999999, 0.999999999, 0.9999999999],
                        dtype=np.float64)

        _ppf = np.array([1.282, 2.326, 3.090, 3.719, 4.265,
        ...
        prob = np.array([0.25, 0.025, 0.0025, 0.00025, 2.5e-05,
                         2.4999999999999998e-06, 2.5e-07, 2.5e-08,
                         2.5e-09, 2.5e-10],
                        dtype=np.float64)
        ...
        prob = np.array([0.1, 0.01, 0.001, 0.0001, 1e-05,
